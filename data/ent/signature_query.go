...
func (sq *SignatureQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (sq *SignatureQuery) FirstIDX(ctx context.Context) uint64 {
...
func (sq *SignatureQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (sq *SignatureQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (sq *SignatureQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (sq *SignatureQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(signature.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Signature.Query().
//		Select(signature.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (sq *SignatureQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(signature.Table, signature.Columns, sqlgraph.NewFieldSpec(signature.FieldID, field.TypeUint64))
	_spec.From = sq.sql
...
func (sq *SignatureQuery) ForUpdate(opts ...sql.LockOption) *SignatureQuery {
...
func (sq *SignatureQuery) ForShare(opts ...sql.LockOption) *SignatureQuery {
	if sq.driver.Dialect() == dialect.Postgres {
		sq.Unique(false)
	}
	sq.modifiers = append(sq.modifiers, func(s *sql.Selector) {
...
func (sq *SignatureQuery) Modify(modifiers ...func(s *sql.Selector)) *SignatureSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (ss *SignatureSelect) Modify(modifiers ...func(s *sql.Selector)) *SignatureSelect {
