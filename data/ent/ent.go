...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			activeinfo.Table:         activeinfo.ValidColumn,
			algorithm.Table:          algorithm.ValidColumn,
			algorithmalarmtype.Table: algorithmalarmtype.ValidColumn,
			area.Table:               area.ValidColumn,
			camera.Table:             camera.ValidColumn,
			device.Table:             device.ValidColumn,
			devicealgo.Table:         devicealgo.ValidColumn,
			devicecamera.Table:       devicecamera.ValidColumn,
			devicetoken.Table:        devicetoken.ValidColumn,
			equipattr.Table:          equipattr.ValidColumn,
			eventsubscription.Table:  eventsubscription.ValidColumn,
			fileupload.Table:         fileupload.ValidColumn,
			inform.Table:             inform.ValidColumn,
			organization.Table:       organization.ValidColumn,
			setting.Table:            setting.ValidColumn,
			signature.Table:          signature.ValidColumn,
			task.Table:               task.ValidColumn,
			taskcamera.Table:         taskcamera.ValidColumn,
			tasklimits.Table:         tasklimits.ValidColumn,
			upplatform.Table:         upplatform.ValidColumn,
			user.Table:               user.ValidColumn,
			warnpush.Table:           warnpush.ValidColumn,
			warnpushlog.Table:        warnpushlog.ValidColumn,
			warnsmserr.Table:         warnsmserr.ValidColumn,
			warningtype.Table:        warningtype.ValidColumn,
		})
	})
