...
func (oc *OrganizationCreate) SetIamRoleID(s string) *OrganizationCreate {
	oc.mutation.SetIamRoleID(s)
	return oc
}

// SetNillableIamRoleID sets the "iam_role_id" field if the given value is not nil.
func (oc *OrganizationCreate) SetNillableIamRoleID(s *string) *OrganizationCreate {
	if s != nil {
		oc.SetIamRoleID(*s)
	}
	return oc
...
func (oc *OrganizationCreate) defaults() error {
	...
	if _, ok := oc.mutation.IamRoleID(); !ok {
		v := organization.DefaultIamRoleID
		oc.mutation.SetIamRoleID(v)
	}
	return nil
}
...
func (oc *OrganizationCreate) check() error {
	...
	if _, ok := oc.mutation.IamRoleID(); !ok {
		return &ValidationError{Name: "iam_role_id", err: errors.New(`ent: missing required field "Organization.iam_role_id"`)}
	}
	return nil
}
...
func (u *OrganizationUpsert) AddParentID(v uint32) *OrganizationUpsert {
	u.Add(organization.FieldParentID, v)
	return u
}

// SetIamRoleID sets the "iam_role_id" field.
func (u *OrganizationUpsert) SetIamRoleID(v string) *OrganizationUpsert {
	u.Set(organization.FieldIamRoleID, v)
	return u
}

// UpdateIamRoleID sets the "iam_role_id" field to the value that was provided on create.
func (u *OrganizationUpsert) UpdateIamRoleID() *OrganizationUpsert {
	u.SetExcluded(organization.FieldIamRoleID)
	return u
}
...
// AddParentID adds v to the "parent_id" field.
func (u *OrganizationUpsertOne) AddParentID(v uint32) *OrganizationUpsertOne {
	return u.Update(func(s *OrganizationUpsert) {
		s.AddParentID(v)
	})
}
...
// SetIamRoleID sets the "iam_role_id" field.
func (u *OrganizationUpsertOne) SetIamRoleID(v string) *OrganizationUpsertOne {
	return u.Update(func(s *OrganizationUpsert) {
		s.SetIamRoleID(v)
	})
}
...
// UpdateIamRoleID sets the "iam_role_id" field to the value that was provided on create.
func (u *OrganizationUpsertOne) UpdateIamRoleID() *OrganizationUpsertOne {
	return u.Update(func(s *OrganizationUpsert) {
		s.UpdateIamRoleID()
	})
}
...
// AddParentID adds v to the "parent_id" field.
func (u *OrganizationUpsertBulk) AddParentID(v uint32) *OrganizationUpsertBulk {
	return u.Update(func(s *OrganizationUpsert) {
		s.AddParentID(v)
	})
}
...
// SetIamRoleID sets the "iam_role_id" field.
func (u *OrganizationUpsertBulk) SetIamRoleID(v string) *OrganizationUpsertBulk {
	return u.Update(func(s *OrganizationUpsert) {
		s.SetIamRoleID(v)
	})
}
...
// UpdateIamRoleID sets the "iam_role_id" field to the value that was provided on create.
func (u *OrganizationUpsertBulk) UpdateIamRoleID() *OrganizationUpsertBulk {
	return u.Update(func(s *OrganizationUpsert) {
		s.UpdateIamRoleID()
	})
}
