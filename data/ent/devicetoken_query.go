...
func (dtq *DeviceTokenQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (dtq *DeviceTokenQuery) FirstIDX(ctx context.Context) uint64 {
...
func (dtq *DeviceTokenQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (dtq *DeviceTokenQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (dtq *DeviceTokenQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (dtq *DeviceTokenQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := dtq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(devicetoken.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.DeviceToken.Query().
//		Select(devicetoken.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (dtq *DeviceTokenQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(devicetoken.Table, devicetoken.Columns, sqlgraph.NewFieldSpec(devicetoken.FieldID, field.TypeUint64))
	_spec.From = dtq.sql
...
func (dtq *DeviceTokenQuery) ForUpdate(opts ...sql.LockOption) *DeviceTokenQuery {
...
func (dtq *DeviceTokenQuery) ForShare(opts ...sql.LockOption) *DeviceTokenQuery {
	if dtq.driver.Dialect() == dialect.Postgres {
		dtq.Unique(false)
	}
	dtq.modifiers = append(dtq.modifiers, func(s *sql.Selector) {
...
func (dtq *DeviceTokenQuery) Modify(modifiers ...func(s *sql.Selector)) *DeviceTokenSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (dts *DeviceTokenSelect) Modify(modifiers ...func(s *sql.Selector)) *DeviceTokenSelect {
