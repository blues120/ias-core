...
const (
	...
	FieldToken = "token"
	// FieldDeviceExtID holds the string denoting the device_ext_id field in the database.
	FieldDeviceExtID = "device_ext_id"
...
// ByDeviceExtID orders the results by the device_ext_id field.
func ByDeviceExtID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldDeviceExtID, opts...).ToFunc()
}
